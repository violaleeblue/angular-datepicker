...
(function(factory) {
  ...
  function DatePicker(picker, settings) {
      ...
      var isNotYetEvaluated = /^\{\{/.test(valueString);
  ...
  DatePicker.prototype.setMin = function(minval) {
    this.set('min', minval)
  };
  ...
  DatePicker.prototype.create = function(type, value, options) {
      ...
      // that it’s a valid date – otherwise default to today.
        ...
        //first time created year is a string with first character removed in firefox and chrome
        value[0] = (typeof(value[0]) === 'string' && value[0].charAt(0) !== '2') ? '2' + value[0] : value[0];
  ...
  DatePicker.prototype.parse = function(type, value, options) {
      ...
      return [
        parsingObject.yyyy || parsingObject.yy, +(parsingObject.mm || parsingObject.m),
                        ...
                        return [
                            _.node(
                              ...
                              targetDate.date, (function(klasses) {
                                ...
                                /* fix for selected date carring over tonext month */
                                // Add the `selected` class if something's selected and the time matches.
                                if (isSelected && selectedObject.month == viewsetObject.month) {
                                  if (selectedObject && viewsetObject) {
                                    if (selectedObject.month == viewsetObject.month) {
